...
public class AlgaeIntakeAngle extends Command {
    private PivotyThing m_PivotyThing = null;

    public AlgaeIntakeAngle() {
        super(PivotyThing.getInstance(), "PivotyThing", "AlgaeIntakeAngle");
    ...
    @Override
    public void execute() {
        m_PivotyThing.setTargetAngle(Constants.PivotConstants.kAlgaeIntakeAngle);
    }
